...
agentVC_MethodVC_dkVCmodelList.kfold <- rrwAddParameterEffectListToRRWModel(agentVC_MethodVCmodelList, c(defaultKilledVC))



allModels <- list(agentVC_MethodVC_dkVCmodelList.kfold = agentVC_MethodVC_dkVCmodelList.kfold)
