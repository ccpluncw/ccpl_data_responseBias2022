...
agentB_agentVC_DKvcModelList.kfold <- rrwAddParameterEffectListToRRWModel(agentVC_DKvcModelList, c(agentB))




allModels <- list(agentB_agentVC_DKvcModelList.kfold = agentB_agentVC_DKvcModelList.kfold)
